...
badd +25 spec/controllers/messages_controller_spec.rb
...
badd +1 app/views/events/_event.html.slim
badd +1 app/views/events/index.html.slim
...
badd +7 spec/mailers/message_mailer_spec.rb
...
badd +5 spec/mailers/previews/message_mailer_preview.rb
badd +1 README.md
badd +1 ~/.vimrc
...
badd +1 spec/features/creating_an_event_spec.rb
badd +1 app/controllers/events_controller.rb
badd +139 spec/controllers/events_controller_spec.rb
badd +17 app/controllers/application_controller.rb
badd +1 app/policies/event_policy.rb
badd +10 spec/policies/event_policy_spec.rb
badd +39 app/policies/application_policy.rb
...
badd +1 spec/controllers/registrations_controller_spec.rb
badd +1 spec/features/user_changes_password_spec.rb
badd +11 spec/features/registrations/sign_up_spec.rb
badd +1 app/policies/page_policy.rb
badd +7 spec/policies/application_policy_spec.rb
badd +15 spec/controllers/application_controller_spec.rb
badd +4 spec/factories/events.rb
badd +1 db/schema.rb
badd +27 spec/models/event_spec.rb
badd +1 config/locales/events.en.yml
badd +2 app/controllers/locations_controller.rb
badd +150 spec/controllers/locations_controller_spec.rb
badd +46 spec/support/controllers/shared_examples.rb
badd +1 spec/support/controllers/shared_contexts.rb
badd +0 spec/factories/locations.rb
badd +5 app/models/location.rb
badd +5 spec/models/location_spec.rb
badd +13 config/locales/locations.en.yml
badd +1 app/controllers/organizations_controller.rb
badd +1 spec/controllers/organizations_controller_spec.rb
badd +0 spec/factories/organizations.rb
badd +5 spec/models/organization_spec.rb
...
argglobal
silent! argdel *
argadd spec/support/controllers/shared_expectations.rb
set stal=2
edit spec/controllers/events_controller_spec.rb
...
exe 'vert 1resize ' . ((&columns * 101 + 76) / 152)
exe 'vert 2resize ' . ((&columns * 50 + 76) / 152)
argglobal
setlocal fdm=syntax
setlocal fde=0
setlocal fmr={{{,}}}
...
exe 'vert 1resize ' . ((&columns * 101 + 76) / 152)
exe 'vert 2resize ' . ((&columns * 50 + 76) / 152)
tabedit spec/support/controllers/shared_examples.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
